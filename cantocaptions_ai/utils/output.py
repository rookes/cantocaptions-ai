...
from cantocaptions_ai.utils.schema import SingleAlignedSegment, SingleWordSegment
...
def merge_segments(seg1: SingleAlignedSegment, seg2: SingleAlignedSegment) -> SingleAlignedSegment:
    s3_start = seg1["start"]
    s3_end = seg2["end"]
    s3_text = seg1["text"] + seg2["text"]
    s3_avg_logprob = None
    s3_words = seg1["words"] + seg2["words"]
