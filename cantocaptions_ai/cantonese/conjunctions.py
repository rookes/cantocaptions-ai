...
conjunctions_by_language = {
    'en': {'and', 'whether', 'or', 'as', 'but', 'so', 'for', 'nor', 'which', 'yet', 'although', 'since', 'unless', 'when', 'while', 'because', 'if', 'how', 'that', 'than', 'who', 'where', 'what',
    'near', 'before', 'after', 'across', 'through', 'until', 'once', 'whereas', 'even', 'both', 'either', 'neither', 'though'},
    ...
    'yue': {'同', '同埋', '或者', '但係', '因為', '任何', '都', '居然', '而且', '所以', '如果', '除非', '甚至', '既然', '雖然', '只要', '直到', '然後', '因此', '唔止', '而係', '不過', '當時'},
}
